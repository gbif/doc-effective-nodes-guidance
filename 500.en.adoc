...
=== How should a GBIF Participant country select the institutional location for a node?
...
* Scientific liaison and promotion of data use in relevant research communities and policy areas
