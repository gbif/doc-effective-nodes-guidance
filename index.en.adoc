...
include::6.-what-is-the-recommended-process-for-establishing-a-participant-node/6.0-introduction/600.en.adoc[]

\\insert inline ref to Box 4 in `600.en.adoc` above\\
...
include::7.-further-support-for-establishing-a-participant-node/700.en.adoc[]
