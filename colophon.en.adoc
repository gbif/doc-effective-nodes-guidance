...
=== Suggested citation
GBIF Secretariat (2025) Establishing an Effective GBIF Participant Node: Concepts and general considerations. GBIF Secretariat: Copenhagen. https://doi.org/10.35035/doc-d601-d695.
...
=== Document Control
Third (GitHub) edition published, May 2025.
